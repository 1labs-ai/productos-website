...
// Company logos for social proof - Clean SVG brand logos
const companies = [
  { 
    name: "Google", 
    logo: (
      <svg className="h-6 w-auto" viewBox="0 0 272 92" fill="currentColor">
  ...
  { 
    name: "Amazon", 
    logo: (
      <svg className="h-5 w-auto" viewBox="0 0 100 30" fill="currentColor">
        <path d="M62.4 21.6c-5.8 4.3-14.3 6.6-21.6 6.6-10.2 0-19.4-3.8-26.4-10.1-.5-.5-.1-1.1.6-.8 7.5 4.4 16.8 7 26.4 7 6.5 0 13.6-1.3 20.1-4.1 1-.4 1.8.7.9 1.4z"/>
        <path d="M64.9 18.8c-.7-.9-4.9-.4-6.8-.2-.6.1-.7-.4-.1-.8 3.3-2.3 8.7-1.7 9.4-.9.6.8-.2 6.3-3.3 8.9-.5.4-1 .2-.7-.3.7-1.8 2.3-5.8 1.5-6.7z"/>
        <path d="M58.2 3.1V.8c0-.3.2-.5.5-.5h9.1c.3 0 .5.2.5.5v2c0 .3-.2.6-.6 1.1l-4.7 6.7c1.7 0 3.6.2 5.2 1.1.4.2.5.5.5.8v2.5c0 .3-.3.7-.7.5-2.8-1.5-6.6-1.6-9.7 0-.3.2-.7-.2-.7-.5v-2.4c0-.4 0-1 .4-1.5l5.5-7.9h-4.8c-.3 0-.5-.2-.5-.5v-.1zM21 15.2h-2.8c-.3 0-.5-.2-.5-.5V.8c0-.3.3-.5.6-.5h2.6c.3 0 .5.2.5.5v1.9h.1c.7-1.8 2-2.7 3.8-2.7 1.8 0 3 .9 3.8 2.7.7-1.8 2.3-2.7 4-2.7 1.2 0 2.5.5 3.3 1.6.9 1.2.7 3 .7 4.6v8.9c0 .3-.3.5-.6.5h-2.8c-.3 0-.5-.2-.5-.5V7.1c0-.6.1-2.1-.1-2.7-.2-.9-.9-1.2-1.7-1.2-.7 0-1.5.5-1.8 1.3-.3.8-.3 2.1-.3 2.6v7.5c0 .3-.3.5-.6.5h-2.8c-.3 0-.5-.2-.5-.5V7.1c0-1.6.3-4-1.8-4-2.1 0-2 2.3-2 4v7.5c0 .3-.3.5-.6.5h.1zM73 .3c4.1 0 6.4 3.6 6.4 8.1 0 4.4-2.5 7.9-6.4 7.9-4.1 0-6.3-3.6-6.3-8 0-4.4 2.3-8 6.3-8zm0 2.9c-2.1 0-2.2 2.8-2.2 4.6 0 1.8 0 5.5 2.2 5.5 2.1 0 2.2-3 2.2-4.9 0-1.2-.1-2.6-.4-3.8-.3-1-1-1.4-1.8-1.4zM84.9 15.2h-2.8c-.3 0-.5-.2-.5-.5V.7c0-.3.3-.5.6-.5h2.6c.2 0 .5.2.5.4v2.2h.1c.8-2 1.9-2.9 3.9-2.9 1.3 0 2.6.5 3.4 1.8.7 1.2.7 3.2.7 4.7v8.3c0 .3-.3.5-.6.5h-2.8c-.3 0-.5-.2-.5-.5V7c0-1.6.2-3.9-1.8-3.9-.7 0-1.4.5-1.7 1.2-.4.9-.5 1.9-.5 2.8v7.6c0 .3-.3.5-.6.5v.1zM50.7 8.6c0 1.1 0 2-.5 2.9-.4.8-1.1 1.2-1.9 1.2-1 0-1.7-.8-1.7-2 0-2.3 2.1-2.7 4.1-2.7v.6zm2.8 6.7c-.2.2-.5.2-.7.1-.9-.8-1.1-1.5-1.7-2.4-1.6 1.6-2.7 2.1-4.8 2.1-2.4 0-4.3-1.5-4.3-4.5 0-2.4 1.3-4 3.1-4.7 1.6-.7 3.8-.8 5.5-1v-.4c0-.7.1-1.5-.4-2.1-.4-.5-1.1-.7-1.7-.7-1.2 0-2.2.6-2.5 1.8-.1.3-.2.5-.5.5l-2.7-.3c-.2-.1-.5-.2-.4-.6.6-3.3 3.6-4.3 6.3-4.3 1.4 0 3.1.4 4.2 1.4 1.4 1.3 1.2 3 1.2 4.9v4.4c0 1.3.6 1.9 1.1 2.6.2.3.2.6 0 .8l-2.3 2-.3-.1h.1zM9.3 8.6c0 1.1 0 2-.5 2.9-.4.8-1.1 1.2-1.9 1.2-1.1 0-1.7-.8-1.7-2 0-2.3 2.1-2.7 4.1-2.7v.6zm2.8 6.7c-.2.2-.5.2-.7.1-.9-.8-1.1-1.5-1.7-2.4-1.6 1.6-2.7 2.1-4.8 2.1-2.4 0-4.3-1.5-4.3-4.5 0-2.4 1.3-4 3.1-4.7 1.6-.7 3.8-.8 5.5-1v-.4c0-.7.1-1.5-.4-2.1-.4-.5-1.1-.7-1.7-.7-1.2 0-2.2.6-2.5 1.8-.1.3-.2.5-.5.5L1.4 4C1.2 4 .9 3.9 1 3.4 1.6.1 4.6-.9 7.3-.9c1.4 0 3.1.4 4.2 1.4C12.9 1.8 12.7 3.5 12.7 5.4v4.4c0 1.3.6 1.9 1.1 2.6.2.3.2.6 0 .8l-2.3 2-.3-.1.9.2z"/>
      </svg>
    )
  },
  { 
